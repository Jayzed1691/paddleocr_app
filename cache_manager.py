...
class CacheManager:
    ...
    def __init__(
        ...
        logger.info(f"Cache manager initialized: dir={self.cache_dir}, max_size={max_size}, ttl={ttl}s")
    ...
    def set(self, file_hash: str, config: Dict[str, Any], result: Any, file_metadata: Dict[str, Any] = None):
        """
